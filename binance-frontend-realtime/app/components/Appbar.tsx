    ...
    return <div className="text-white border-b border-slate-800">
        <div className="flex justify-between items-center p-2">
            <div className="flex">
                ...
                <div className={`text-sm pt-1 flex flex-col justify-center pl-8 cursor-pointer ${route.startsWith('/assets') ? 'text-white' : 'text-slate-500'}`} onClick={() => router.push('/assets')}>
                    Assets
                </div>
            </div>
            <div className="flex">
